...
*/
DELETE FROM `npc_vendor` WHERE (`entry` = 13217) AND (`item` IN (19308, 19309, 19310, 19311, 19312, 19315, 19321, 19323, 19324, 21563));
...
/*
  Restore <Legacy Armor Quartermaster> lvl 60 items, do not delete the previous items lvl 50-59
