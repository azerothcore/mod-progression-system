...
-- alliance 12784, 12785, 12778, 34075, 34078, 34081, 40607
-- horde 12794, 12795, 12788, 34043, 34038, 34060, 34063
UPDATE `creature_template` SET `npcflag` = `npcflag` &~128 WHERE `entry` IN (12784, 12785, 12778, 12794, 12795, 12788, 34075, 34078, 34081, 34043, 34038, 34060, 34063, 40607);
UPDATE `creature_template` SET `npcflag` = `npcflag` &~4096 WHERE `entry` IN (12784, 12785, 12778, 12794, 12795, 12788, 34075, 34078, 34081, 34043, 34038, 34060, 34063, 40607);
