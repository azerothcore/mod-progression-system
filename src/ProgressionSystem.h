...
enum ProgressionBrackets
{
    ...
    PROGRESSION_BRACKET_60_TIER_3_C_AHN_QIRAJ   = 0x00002000,
    PROGRESSION_BRACKET_61_64                   = 0x00004000,
    PROGRESSION_BRACKET_65_69                   = 0x00008000,
    PROGRESSION_BRACKET_70_TIER_4               = 0x00010000,
    PROGRESSION_BRACKET_70_TIER_5               = 0x00020000,
    PROGRESSION_BRACKET_70_TIER_6_A             = 0x00040000,
    PROGRESSION_BRACKET_70_TIER_6_B             = 0x00080000,
    PROGRESSION_BRACKET_70_TIER_6_C             = 0x00100000,
    PROGRESSION_BRACKET_71_74                   = 0x00200000,
    PROGRESSION_BRACKET_75_79                   = 0x00400000,
    PROGRESSION_BRACKET_80_TIER_7               = 0x00800000,
