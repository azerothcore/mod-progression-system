...
VALUES (128, @MapID, 0, 604800, 25, 'RAID_DIFFICULTY_25PLAYER');
...
(2177, 1859, 2185, 1857, 575, 2140, 573, 2179, 2183, 2181, 563, 565, 579, 577,
2147, 569, 567, 2139, 2186)
AND `sourceType` = 4;
...
SET @Nonbosses := (29356, 29824, 29823, 29831, 29833, 29842, 29825, 29828,
29835, 29576, 30097, 29837, 29898, 29899, 29900, 29242, 29241, 29243, 29229,
30389, 29286, 29247, 29613, 29248, 29575, 29574, 30075, 30087, 29347, 29353,
29362, 29359, 29363, 29355, 29371, 29609, 29608, 29603, 29601, 29612, 31542,
29852, 30424);
UPDATE `creature_template` SET `lootid` = 0, `skinloot` = 0 WHERE `entry` IN @Nonbosses;
-- No need to set nonbosses that are spawned as they don't drop loot
--SET @NonbossesSpawned := (30047, 30049, 30016, 29279, 29632, 29633, 29635,
--29634, 29941, 29267, 29256, 29274, 29273, 30057, 30303, 29388, 30068, 29988,
--29989, 29990, 30264, 29986, 29985, 29987);

-- Disable loot for bosses
SET @Bosses := (29373, 29417, 29701, 29268, 29615, 29249, 29718, 29324, 29955,
29940, 29448, 29278, 30603, 30601, 30600, 30602, 29991, 30061);
DELETE FROM `creature_loot_template` WHERE `entry` IN @Bosses;
...
(@Thaddius, 22353, 0, 100, 0, 1, 2, 1, 1, 'Desecrated Helmet'),
(@Thaddius, 22360, 0, 100, 0, 1, 2, 1, 1, 'Desecrated Headpiece'),
(@Thaddius, 22367, 0, 100, 0, 1, 2, 1, 1, 'Desecrated Circlet'),
(@Thaddius, 22801, 0, 100, 0, 1, 3, 1, 1, 'Spire of Twilight'),
(@Thaddius, 22808, 0, 100, 0, 1, 3, 1, 1, 'The Castigator'),
(@Thaddius, 23000, 0, 100, 0, 1, 3, 1, 1, 'Plated Abomination Ribcage'),
(@Thaddius, 23001, 0, 100, 0, 1, 3, 1, 1, 'Eye of Diminution'),
(@Thaddius, 23070, 0, 100, 0, 1, 3, 1, 1, 'Leggings of Polarity');